...
var batFile = new File(documentsFolder + "/run_prism_Tools.bat");
...
if (!batFile.exists) {
    ...
    batFile.writeln('start "" "PRISMLIBS/Python311/Prism.exe" "PLUGINROOT/Scripts/Prism_Illustrator_MenuTools.py" "PRISMROOT" Tools');
    batFile.close();
}
